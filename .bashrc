...
__conda_setup="$('/home/collatz124/anaconda3/bin/conda' 'shell.bash' 'hook' 2> /dev/null)"
if [ $? -eq 0 ]; then
    eval "$__conda_setup"
else
    if [ -f "/home/collatz124/anaconda3/etc/profile.d/conda.sh" ]; then
        . "/home/collatz124/anaconda3/etc/profile.d/conda.sh"
    else
        export PATH="/home/collatz124/anaconda3/bin:$PATH"
    fi
fi
unset __conda_setup
# <<< conda initialize <<<
...
prompt-med -P --prompt="$ " --time="%A, %B %d - %H:%M" 
#:
#:------------------------------------------------------------------------


alias config='/usr/bin/git --git-dir=/home/collatz124/dotfiles/ --work-tree=/home/collatz124'
